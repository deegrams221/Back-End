...
{
    private static final Logger logger = LoggerFactory.getLogger(VacationplannerApplication.class);
    ...
    public DataSource dataSource()
    {
        ...
        if (dbValue.equalsIgnoreCase("POSTGRESQL"))
        {
            ...
            myUrlString = "jdbc:postgresql://" + System.getenv("MYDBHOST")
                    + ":5432/" + System.getenv("MYDBNAME");
