package com.lambdaschool.vacationplanner.logging;
...
{
    @Around(value = "@within(com.lambdaschool.vacationplanner.logging.Loggable) || " +
            "@annotation(com.lambdaschool.vacationplanner.logging.Loggable)")
