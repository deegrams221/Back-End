package com.lambdaschool.vacaplanner.logging;
...
{
    @Around(value = "@within(com.lambdaschool.vacaplanner.logging.Loggable) || @annotation(com.lambdaschool.vacaplanner.logging.Loggable)")
